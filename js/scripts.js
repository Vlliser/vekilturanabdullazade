...
const translations = {
  az: {
    ...
    footer_copy: "© 2025 Abdullazadə Turan. Bütün hüquqlar qorunur."
  },
  ...
  ru: {
    ...
    footer_copy: "© 2025 Абдуллазаде Туран. Все права защищены."
  },
  ...
  en: {
    ...
    footer_copy: "© 2025 Abdullazade Turan. All rights reserved."
  }
};
...
function setLanguage(lang) {
  ...
  // Handle data-i18n-ph (placeholder on non-input parents — just in case)
  ...
  const titles = {
    az: 'Abdullazadə Turan — Vəkil | Bakı',
    ru: 'Абдуллазаде Туран — Адвокат | Баку',
    en: 'Abdullazade Turan — Attorney at Law | Baku'
  };
...
// Hero stats: animate on page load after preloader hides
window.addEventListener('load', () => {
  setTimeout(() => {
    document.querySelectorAll('.hero-stat-num[data-count]').forEach(c => animateCounter(c));
  }, 1300);
});
...
// Show admin badge only on localhost/dev
